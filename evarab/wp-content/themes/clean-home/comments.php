...
<?php if ($comments) : ?>
	...
	<h3><?php comments_number('Inga kommentarer', 'En kommentar', '% kommentarer' );?> on &#8220;<?php the_title(); ?>&#8221;</h3>
	...
	<?php $count_pings = 1; foreach ($comments as $comment) : ?>
		...
		<li <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
			...
			<p><b>Håll ut, kommentaren ska bara modereras.</b></p>
			<?php endif; ?>
		</li>
...
<h4 class="center">Säg nåt</h4>

<?php if ( get_option('comment_registration') && !$user_ID ) : ?>
<p>Du måste vara <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php echo urlencode(get_permalink()); ?>">inloggad för att</a> kommentera.</p>
<?php else : ?>
