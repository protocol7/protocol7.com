...
<div id="northsidebar" class="sidebar">
	...
	<div class="widget widget_feeds">
		<div class="content">
			<div id="subscribe">
				<a rel="external nofollow" id="feedrss" title="<?php _e('Subscribe to this blog...', 'inove'); ?>" href="<?php echo $feed; ?>"><?php _e('<abbr title="Really Simple Syndication"></abbr>', 'inove'); ?></a>
			...
			<?php endif; ?>
<a href="http://twitter.com/evarab" alt="Follow me at Twitter"><img src="http://protocol7.com/evarab/images/Twitter-48x48.png"></a>	
<a href="http://www.facebook.com/profile.php?id=532085819" alt="Follow me at Facebook"><img src="http://protocol7.com/evarab/images/FaceBook-48x48.png"></a>	
			<div class="fixed"></div>
	</div>
