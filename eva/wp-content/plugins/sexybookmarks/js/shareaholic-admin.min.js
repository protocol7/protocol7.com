...
"checked");jQuery("#shr-twitter").attr("checked","checked");jQuery("#shr-linkedin").attr("checked","checked");jQuery("#shr-googlebookmarks").attr("checked","checked");jQuery("#shr-delicious").attr("checked","checked");jQuery("#shr-stumbleupon").attr("checked","checked");jQuery("#shr-reddit").attr("checked","checked");jQuery("#shr-gmail").attr("checked","checked");jQuery("#shr-mail").attr("checked","checked");jQuery("#shr-printfriendly").attr("checked","checked")})});jQuery("#preset-amounts").parent("label").click(function(){jQuery("#custom-amounts").attr("disabled",
...
jQuery("#twitter-defaults").fadeOut()});jQuery("#shorty").change(function(){jQuery("#shortyapimdiv-bitly").fadeOut("fast");jQuery("#shortyapimdiv-supr").fadeOut("fast");jQuery("#shortyapimdiv-jmp").fadeOut("fast");this.value=="bitly"?jQuery("#shortyapimdiv-bitly").fadeIn("fast"):this.value=="supr"?jQuery("#shortyapimdiv-supr").fadeIn("fast"):this.value=="jmp"&&jQuery("#shortyapimdiv-jmp").fadeIn("fast")});jQuery("#shortyapichk-supr").click(function(){this.checked?jQuery("#shortyapidiv-supr").fadeIn("fast"):
jQuery("#shortyapidiv-supr").fadeOut("fast")});jQuery("#likeButtonSetTop-yes").click(function(){this.checked&&jQuery(".likeButtonsAvailableTop").fadeIn("fast")});jQuery("#likeButtonSetTop-no").click(function(){this.checked&&jQuery(".likeButtonsAvailableTop").fadeOut("fast")});jQuery("#likeButtonSetBottom-yes").click(function(){this.checked&&jQuery(".likeButtonsAvailableBottom").fadeIn("fast")});jQuery("#likeButtonSetBottom-no").click(function(){this.checked&&jQuery(".likeButtonsAvailableBottom").fadeOut("fast")});
...
c=jQuery("#tweetconfig").val();c=c.replace("${title}","Some fancy post title");c=c.replace("${short_link}","http://goo.gl/dbqlx");jQuery("#tweetoutput span").html(c);jQuery("#tweetconfig").keyup(function(){var c=0;jQuery("#tweetconfig").val().indexOf("${title}")!=-1&&(c=Math.floor(c+8));jQuery("#tweetconfig").val().indexOf("${short_link}")!=-1&&(c=Math.floor(c+13));c=Math.floor(jQuery(this).val().length-c);if(c>=50)return jQuery("#tweetcounter span").addClass("error"),alert("You need to leave room for the short URL and/or post title..."),
...
function(){jQuery("#tip_text_color").val("#ffffff");jQuery("#tip_text_color_picker div").css("backgroundColor","#ffffff")})}});
(function(c){var j=function(){var f=65,j={eventName:"click",onShow:function(){},onBeforeShow:function(){},onHide:function(){},onChange:function(){},onSubmit:function(){},color:"ff0000",livePreview:!0,flat:!1},k=function(a,b){var d=i(a);c(b).data("colorpicker").fields.eq(1).val(d.r).end().eq(2).val(d.g).end().eq(3).val(d.b).end()},p=function(a,b){c(b).data("colorpicker").fields.eq(4).val(a.h).end().eq(5).val(a.s).end().eq(6).val(a.b).end()},m=function(a,b){c(b).data("colorpicker").fields.eq(0).val(l(i(a))).end()},
q=function(a,b){c(b).data("colorpicker").selector.css("backgroundColor","#"+l(i({h:a.h,s:100,b:100})));c(b).data("colorpicker").selectorIndic.css({left:parseInt(150*a.s/100,10),top:parseInt(150*(100-a.b)/100,10)})},r=function(a,b){c(b).data("colorpicker").hue.css("top",parseInt(150-150*a.h/360,10))},t=function(a,b){c(b).data("colorpicker").currentColor.css("backgroundColor","#"+l(i(a)))},s=function(a,b){c(b).data("colorpicker").newColor.css("backgroundColor","#"+l(i(a)))},E=function(a){a=a.charCode||
a.keyCode||-1;if(a>f&&a<=90||a==32)return!1;c(this).parent().parent().data("colorpicker").livePreview===!0&&n.apply(this)},n=function(a){var b=c(this).parent().parent(),d;if(this.parentNode.className.indexOf("_hex")>0){d=b.data("colorpicker");var e=this.value,g=6-e.length;if(g>0){for(var h=[],f=0;f<g;f++)h.push("0");h.push(e);e=h.join("")}e=o(u(e));d.color=d=e}else this.parentNode.className.indexOf("_hsb")>0?b.data("colorpicker").color=d=v({h:parseInt(b.data("colorpicker").fields.eq(4).val(),10),
s:parseInt(b.data("colorpicker").fields.eq(5).val(),10),b:parseInt(b.data("colorpicker").fields.eq(6).val(),10)}):(d=b.data("colorpicker"),e=parseInt(b.data("colorpicker").fields.eq(1).val(),10),g=parseInt(b.data("colorpicker").fields.eq(2).val(),10),h=parseInt(b.data("colorpicker").fields.eq(3).val(),10),e={r:Math.min(255,Math.max(0,e)),g:Math.min(255,Math.max(0,g)),b:Math.min(255,Math.max(0,h))},d.color=d=o(e));a&&(k(d,b.get(0)),m(d,b.get(0)),p(d,b.get(0)));q(d,b.get(0));r(d,b.get(0));s(d,b.get(0));
b.data("colorpicker").onChange.apply(b,[d,l(i(d)),i(d)])},F=function(){c(this).parent().parent().data("colorpicker").fields.parent().removeClass("colorpicker_focus")},G=function(){f=this.parentNode.className.indexOf("_hex")>0?70:65;c(this).parent().parent().data("colorpicker").fields.parent().removeClass("colorpicker_focus");c(this).parent().addClass("colorpicker_focus")},H=function(a){var b=c(this).parent().find("input").focus(),a={el:c(this).parent().addClass("colorpicker_slider"),max:this.parentNode.className.indexOf("_hsb_h")>
...
m(a.data.cal.data("colorpicker").color,a.data.cal.get(0));c(document).unbind("mouseup",y);c(document).unbind("mousemove",z);return!1},J=function(){var a={cal:c(this).parent(),pos:c(this).offset()};a.preview=a.cal.data("colorpicker").livePreview;c(document).bind("mouseup",a,A);c(document).bind("mousemove",a,B)},B=function(a){n.apply(a.data.cal.data("colorpicker").fields.eq(6).val(parseInt(100*(150-Math.max(0,Math.min(150,a.pageY-a.data.pos.top)))/150,10)).end().eq(5).val(parseInt(100*Math.max(0,Math.min(150,
a.pageX-a.data.pos.left))/150,10)).get(0),[a.data.preview]);return!1},A=function(a){k(a.data.cal.data("colorpicker").color,a.data.cal.get(0));m(a.data.cal.data("colorpicker").color,a.data.cal.get(0));c(document).unbind("mouseup",A);c(document).unbind("mousemove",B);return!1},K=function(){c(this).addClass("colorpicker_focus")},L=function(){c(this).removeClass("colorpicker_focus")},M=function(){var a=c(this).parent(),b=a.data("colorpicker").color;a.data("colorpicker").origColor=b;t(b,a.get(0));a.data("colorpicker").onSubmit(b,
l(i(b)),i(b),a.data("colorpicker").el)},D=function(){var a,b,d,e,g=c("#"+c(this).data("colorpickerId"));g.data("colorpicker").onBeforeShow.apply(this,[g.get(0)]);var h=c(this).offset();e=document.compatMode=="CSS1Compat";a=window.pageXOffset||(e?document.documentElement.scrollLeft:document.body.scrollLeft);b=window.pageYOffset||(e?document.documentElement.scrollTop:document.body.scrollTop);d=window.innerWidth||(e?document.documentElement.clientWidth:document.body.clientWidth);e=window.innerHeight||
...
g:Math.round(c),b:Math.round(e)}},l=function(a){var b=[a.r.toString(16),a.g.toString(16),a.b.toString(16)];c.each(b,function(a,c){c.length==1&&(b[a]="0"+c)});return b.join("")},O=function(){var a=c(this).parent(),b=a.data("colorpicker").origColor;a.data("colorpicker").color=b;k(b,a.get(0));m(b,a.get(0));p(b,a.get(0));q(b,a.get(0));r(b,a.get(0));s(b,a.get(0))};return{init:function(a){a=c.extend({},j,a||{});if(typeof a.color=="string")a.color=o(u(a.color));else if(a.color.r!=void 0&&a.color.g!=void 0&&
a.color.b!=void 0)a.color=o(a.color);else if(a.color.h!=void 0&&a.color.s!=void 0&&a.color.b!=void 0)a.color=v(a.color);else return this;return this.each(function(){if(!c(this).data("colorpickerId")){var b=c.extend({},a);b.origColor=a.color;var d="collorpicker_"+parseInt(Math.random()*1E3);c(this).data("colorpickerId",d);d=c('<div class="colorpicker"><div class="colorpicker_color"><div><div></div></div></div><div class="colorpicker_hue"><div></div></div><div class="colorpicker_new_color"></div><div class="colorpicker_current_color"></div><div class="colorpicker_hex"><input type="text" maxlength="6" size="6" /></div><div class="colorpicker_rgb_r colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_rgb_g colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_rgb_b colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_h colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_s colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_b colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_submit"></div></div>').attr("id",
d);b.flat?d.appendTo(this).show():d.appendTo(document.body);b.fields=d.find("input").bind("keyup",E).bind("change",n).bind("blur",F).bind("focus",G);d.find("span").bind("mousedown",H).end().find(">div.colorpicker_current_color").bind("click",O);b.selector=d.find("div.colorpicker_color").bind("mousedown",J);b.selectorIndic=b.selector.find("div div");b.el=this;b.hue=d.find("div.colorpicker_hue div");d.find("div.colorpicker_hue").bind("mousedown",I);b.newColor=d.find("div.colorpicker_new_color");b.currentColor=
