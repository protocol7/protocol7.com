...
// --------------------------------------------------------------------------------
// Backupify PclZip Library 1.0.0 - readme.txt
// --------------------------------------------------------------------------------
// Description :
// BackupifyPclZip is a PclZip library that is specifically modified for use in 
// the wp-backupify plugin. The main class, some functions and constants
// renamed in order to avoid incompatibility with other Wordpress plugins.
// --------------------------------------------------------------------------------
