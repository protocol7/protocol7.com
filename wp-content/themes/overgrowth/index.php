...
<?php get_header(); ?>	
	<div id="wrapper">
		...
		<div id="content-wrapper">
			...
			<div><img src="<?php bloginfo('stylesheet_directory'); ?>/images/icon1.gif" alt="icon1" /> <?php the_author() ?> | <img src="<?php bloginfo('stylesheet_directory'); ?>/images/icon2.gif" alt="icon2" /> <?php the_tags('Tags: ', ', ', '.'); ?> | <img src="<?php bloginfo('stylesheet_directory'); ?>/images/icon4.gif" alt="icon4" /> <?php the_time('m jS, Y') ?><strong>|</strong> <?php edit_post_link('Edit','','<strong>|</strong>'); ?> <img src="<?php bloginfo('stylesheet_directory'); ?>/images/icon3.gif" alt="icon3" /><?php comments_popup_link('No Comments &raquo;', '1 Comment &raquo;', '% Comments &raquo;'); ?></div>
</div>
